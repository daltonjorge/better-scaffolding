...
Taglib for Pagination Fix on Bootstrap
======================================

1. Create a new taglib and put the code below:

```groovy
package change_this_package_name
...
2. Insert the line below in your *config.groovy* file:
