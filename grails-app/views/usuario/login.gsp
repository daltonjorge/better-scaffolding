    ...
    <div class="container">
      <div class="row">
        <g:if test="${flash.message}">
         <div class="alert alert-warning text-center" role="status" id="alerta">
            <a class="close" data-dismiss="alert" onclick="$('#alerta').hide(500);">×</a>${flash.message}
         </div>
        </g:if>
        <div class="col-sm-6 col-md-4 col-md-offset-4">
          <h1 class="text-center login-title">Acesso ao Sistema</h1>
